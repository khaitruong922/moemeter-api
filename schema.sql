...
--
-- Name: blacklisted_series; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.blacklisted_series (
    id integer NOT NULL
);


ALTER TABLE public.blacklisted_series OWNER TO postgres;
...
CREATE MATERIALIZED VIEW public.series_leaderboard AS
 WITH canonical_books AS (
         ...
         SELECT bs.series_id,
            ...
            (COALESCE(sum(COALESCE(bs.page, 0)), (0)::bigint))::integer AS total_pages
           FROM book_stats bs
...
--
-- Name: blacklisted_series blacklisted_series_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.blacklisted_series
    ADD CONSTRAINT blacklisted_series_pkey PRIMARY KEY (id);
...
--
-- Name: blacklisted_series; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.blacklisted_series ENABLE ROW LEVEL SECURITY;
