...
export const parsePerPageMonthly = (query: string | undefined) => applyNaNVL(parseNatNum(query), DEFAULT_LIMITS.SUMMARY_MONTHLY_LIMIT) as PerPageMonthly

type PerPageYearly = Branded<number, 'PerPageYearly'>
export const parsePerPageYearly = (query: string | undefined) => applyNaNVL(parseNatNum(query), DEFAULT_LIMITS.SUMMARY_YEARLY_LIMIT) as PerPageYearly
