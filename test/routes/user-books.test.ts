...
describe('GET /users/:id/books/read', () => {
	...
	it('Should return books with GET /users/618830/books/read?page=1&per_page=1&order=1', async () => {
		const res = await app.request('/users/618830/books/read?page=1&per_page=1&order=1');
		expect(res.status).toBe(200);
		const data = await res.json();
...
describe('GET /users/:id/books/reading', () => {
	...
	it('Should return books with GET /users/618830/books/reading?page=1&per_page=1&order=1', async () => {
		const res = await app.request('/users/618830/books/reading?page=1&per_page=1&order=1');
		expect(res.status).toBe(200);
		const data = await res.json();
...
describe('GET /users/:id/books/stacked', () => {
	...
	it('Should return books with GET /users/618830/books/stacked?page=1&per_page=1&order=1', async () => {
		const res = await app.request('/users/618830/books/stacked?page=1&per_page=1&order=1');
		expect(res.status).toBe(200);
		const data = await res.json();
		expect(data['books'][0]).not.toBeUndefined();
		expect(data['books'][1]).toBeUndefined();
...
describe('GET /users/:id/books/wish', () => {
	...
	it('Should return books with GET /users/618830/books/wish?page=1&per_page=1&order=1', async () => {
		const res = await app.request('/users/618830/books/wish?page=1&per_page=1&order=1');
		expect(res.status).toBe(200);
		const data = await res.json();
		expect(data['books'][0]).not.toBeUndefined();
		expect(data['books'][1]).toBeUndefined();
